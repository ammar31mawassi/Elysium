...
export const demoContent = {
  ...
  helpers: [
    { id: "demo-helper-sara", owner_user_id: "demo-helper-user-1", display_name: "Sara M.", university_id: bguId, field_of_study: "Information Systems", academic_year: "3rd Year", languages: ["Arabic", "Hebrew", "English"], help_topics: ["First week", "Moodle", "Course registration"], bio: "Happy to help new students understand where to start.", availability: "Usually replies in the evening", contact_method: "whatsapp", contact_consent: false, is_visible: true, moderation_status: "ok" },
    { id: "demo-helper-daniel", owner_user_id: "demo-helper-user-2", display_name: "Daniel K.", university_id: bguId, field_of_study: "Psychology", academic_year: "4th Year+", languages: ["Hebrew", "English"], help_topics: ["Scholarships", "Reserve duty support", "Student services"], bio: "I can point you toward the right official office and share what worked for me.", availability: "Weekdays", contact_method: "whatsapp", contact_consent: false, is_visible: true, moderation_status: "ok" },
  ],
  guides: [
